...
@Configuration
@EnableJpaRepositories("com.openclinica.ui.repository")
...
public class DatabaseConfiguration implements EnvironmentAware {
    ...
    @ConditionalOnMissingClass(name = "com.openclinica.ui.config.HerokuDatabaseConfiguration.class")
    ...
    public List<String> getBasePackages() {
        ...
        basePackages.add("com.openclinica.ui.domain");
        return basePackages;
    }
