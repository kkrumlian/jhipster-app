define([
        ...
        'account/logout/logout-module',
        'account/register/register-module',
        'account/settings/settings-module',
        'account/password/password-module',
        'account/sessions/sessions-module',
        'account/activate/activate-module'
    ], function( angular ) {

        return angular.module('PP-account', [
